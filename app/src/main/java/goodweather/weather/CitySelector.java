...
public class CitySelector extends Fragment implements IObserver {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            cityName = savedInstanceState.getString("cityName", getLastCityName());
        }
    ...
    private void initList() {
        IRVOnItemClick cityListOnClick = cityName -> {
            ...
            ((MainActivity)requireActivity()).setWeatherFragment(null);
        };
    ...
    public static void addCity(Activity activity, LifecycleOwner lifecycleOwner, String cityName,
        ...
        RetrofitGetter.getData(activity.getApplicationContext(), lifecycleOwner, cityName, null, null,
